describe "bootbox.prompt", ->
  beforeEach ->
    ...
    @find   = (selector) -> @diaBrk000_Log.find selector
      ...
      describe "where the argument is an object", ->
        ...
        describe "with a title and a callback", ->
          ...
          it "applies the bootbox-prompt class to the dialog", ->
            expect(@diaBrk000_Log.hasClass("bootbox-prompt")).to.be.true

          it "adds the correct button labels", ->
            expect(@diaBrk000_Log.find(".btn:first").text()).to.equal "Cancel"
            expect(@diaBrk000_Log.find(".btn:last").text()).to.equal "OK"

          it "adds the correct button classes", ->
            expect(@diaBrk000_Log.find(".btn:first").hasClass("btn-default")).to.be.true
            expect(@diaBrk000_Log.find(".btn:last").hasClass("btn-primary")).to.be.true
    ...
    describe "with two arguments", ->
      ...
      describe "where the second argument is a function", ->
        ...
        it "adds a close button", ->
          expect(@diaBrk000_Log.find(".modal-header .close")).to.be.ok

        it "creates a form with a text input", ->
          expect(@diaBrk000_Log.find("form input[type=text]")).to.be.ok

        it "with no default value", ->
          expect(@diaBrk000_Log.find("form input[type=text]").val()).to.equal ""

        it "shows the dialog", ->
          expect(@diaBrk000_Log.is(":visible")).to.be.true
  ...
  describe "configuration options tests", ->
    ...
    describe "with a custom cancel button", ->
      beforeEach ->
        ...
        @button = @diaBrk000_Log.find(".btn:first")
    ...
    describe "with a custom confirm button", ->
      beforeEach ->
        ...
        @button = @diaBrk000_Log.find(".btn:last")
  ...
  describe "callback tests", ->
    describe "with a simple callback", ->
      ...
      describe "when entering no value in the text input", ->
        ...
        describe "when dismissing the dialog by clicking OK", ->
          beforeEach ->
            @diaBrk000_Log.find(".btn-primary").trigger "click"
        ...
        describe "when submitting the form", ->
          beforeEach ->
            @diaBrk000_Log.find(".bootbox-form").trigger "submit"
      ...
      describe "when entering a value in the text input", ->
        beforeEach ->
          @diaBrk000_Log.find(".bootbox-input").val "Test input"
      ...
      describe "when dismissing the dialog by clicking Cancel", ->
        beforeEach ->
          @diaBrk000_Log.find(".btn-default").trigger "click"
      ...
      describe "when triggering the escape event", ->
        beforeEach ->
          @diaBrk000_Log.trigger "escape.close.bb"
      ...
      describe "when dismissing the dialog by clicking the close button", ->
        beforeEach ->
          @diaBrk000_Log.find(".close").trigger "click"
    ...
    describe "with a default value", ->
      ...
      it "populates the input with the default value", ->
        expect(@diaBrk000_Log.find(".bootbox-input").val()).to.equal "Bob"
      ...
      describe "when entering a value in the text input", ->
        beforeEach ->
          @diaBrk000_Log.find(".bootbox-input").val "Alice"
    ...
    describe "with a placeholder", ->
      ...
      it "populates the input with the placeholder attribute", ->
        expect(@diaBrk000_Log.find(".bootbox-input").attr("placeholder")).to.equal "e.g. Bob Smith"
    ...
    describe "with inputType select", ->
      ...
      describe "with a default value", ->
        ...
        it "specified option is selected", ->
          expect(@diaBrk000_Log.find(".bootbox-input-select").val()).to.equal "1"
        ...
        describe "when changing the selected option and dismissing the dialog by clicking OK", ->
          beforeEach ->
            @diaBrk000_Log.find(".bootbox-input-select").val(3)
            @diaBrk000_Log.find(".btn-primary").trigger "click"
    ...
    describe "with inputType email", ->
      describe "without a default value", ->
        ...
        describe "when entering a value in the email input", ->
          beforeEach ->
            @diaBrk000_Log.find(".bootbox-input-email").val "john@smith.com"
      ...
      describe "with a default value", ->
        ...
        describe "when changing a value in the email input", ->
          beforeEach ->
            @diaBrk000_Log.find(".bootbox-input-email").val "smith@john.com"
      ...
      describe "with default value", ->
        describe "one value checked", ->
          ...
          it "specified checkbox is checked", ->
            expect(@diaBrk000_Log.find("input:checkbox:checked").val()).to.equal "2"
          ...
          describe "when changing the checked option and dismissing the dialog by clicking Cancel", ->
            beforeEach ->
              @diaBrk000_Log.find("input:checkbox:checked").prop('checked', false)
              @diaBrk000_Log.find("input:checkbox[value=3]").prop('checked', true)
              @diaBrk000_Log.find(".btn-default").trigger "click"
        ...
        describe "multiple value checked", ->
          ...
          it "specified checkboxes are checked", ->
            ...
            @diaBrk000_Log.find("input:checkbox:checked").each (foo, bar) =>
          ...
          describe "when changing the checked options and dismissing the dialog by clicking Cancel", ->
            beforeEach ->
              @diaBrk000_Log.find("input:checkbox:checked").prop('checked', false)
              @diaBrk000_Log.find("input:checkbox[value=1]").prop('checked', true)
              @diaBrk000_Log.find("input:checkbox[value=4]").prop('checked', true)
              @diaBrk000_Log.find(".btn-default").trigger "click"
