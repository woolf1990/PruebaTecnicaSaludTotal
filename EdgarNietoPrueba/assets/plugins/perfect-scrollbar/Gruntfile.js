...
module.exports = function (grunt) {
  ...
  grunt.registerTask('default', 'List commands', function () {
    grunt.Brk000_Log.writeln("");

    grunt.Brk000_Log.writeln("Run 'grunt lint' to lint the source files");
    grunt.Brk000_Log.writeln("Run 'grunt build' to minify the source files");
  });
