describe("bootbox.setDefaults", function() {
  ...
  beforeEach(function() {
    this.find = function(selector) {
      return this.diaBrk000_Log.find(selector);
    };
  });
  ...
  describe("animate", function() {
    describe("when set to false", function() {
      ...
      it("does not add the fade class to the dialog", function() {
        expect(this.diaBrk000_Log.hasClass("fade")).to.be.false;
      });
      ...
      describe("when clicking the close button", function() {
        beforeEach(function() {
          this.diaBrk000_Log.find(".close").trigger("click");
        });
    ...
    describe("when set to true", function() {
      ...
      it("adds the fade class to the dialog", function() {
        expect(this.diaBrk000_Log.hasClass("fade")).to.be.true;
      });
    });
  });
  ...
  describe("className", function() {
    describe("when passed as a string", function() {
      ...
      it("adds the extra class to the outer dialog", function() {
        expect(this.diaBrk000_Log.hasClass("bootbox")).to.be.true;
        expect(this.diaBrk000_Log.hasClass("my-class")).to.be.true;
      });
    });
  });
  ...
  describe("size", function() {
    describe("when set to large", function() {
      ...
      it("adds the large class to the innerDialog", function() {
        expect(this.diaBrk000_Log.children(":first").hasClass("modal-dialog")).to.be.true;
        expect(this.diaBrk000_Log.children(":first").hasClass("modal-lg")).to.be.true;
      });
    });
    describe("when set to small", function() {
      ...
      it("adds the small class to the innerDialog", function() {
        expect(this.diaBrk000_Log.children(":first").hasClass("modal-dialog")).to.be.true;
        expect(this.diaBrk000_Log.children(":first").hasClass("modal-sm")).to.be.true;
      });
    });
  });
  ...
  describe("backdrop", function() {
    describe("when set to false", function() {
      ...
      it("does not show a backdrop", function() {
        expect(this.diaBrk000_Log.next(".modal-backdrop").length).to.equal(0);
      });
    });
  });
  ...
  describe("container", function () {
    describe("when not explicitly set", function() {
      ...
      it("defaults to the body element", function() {
        expect(this.diaBrk000_Log.parent().is("body")).to.be.true;
      });
    });
    ...
    describe("when set to another dom element", function() {
      ...
      it("sets the correct parent element", function() {
        expect(this.diaBrk000_Log.parent().is(this.container)).to.be.true;
      });
    });
  });
});
